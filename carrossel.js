window.onload = () => {
    ...
    function startAutoSlide() {
      autoSlide = setInterval(() => {
        ...
        preview();
        scrollGallery(galleryContainer.scrollLeft);
      }, 4500);
    }
  
    function resetAutoSlide(currentScrollPosition = 0) {
      clearInterval(autoSlide);
      if (!isMouseDown) {
        startAutoSlide(currentScrollPosition);
      }
    }
  
    function scrollGallery(currentScrollPosition = 0) {
      if (newIndex >= gallery.length) {
        newIndex = 0;
        ...
        galleryContainer.scrollTo({
          left: currentScrollPosition + galleryContainer.clientWidth,
          behavior: 'smooth'
        });
    ...
    prevButton.onclick = () => {
      ...
      nextButton.style.display = "block";
      preview();
      resetAutoSlide(galleryContainer.scrollLeft);
      scrollGallery();
    };
